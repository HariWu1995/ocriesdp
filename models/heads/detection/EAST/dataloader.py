...
class Processor(object):
    ...
    def __init__(self, image_shape=[512, 512], background_ratio=0.125,
                min_crop_side_ratio=0.1, min_text_size=10, **kwargs):
    ...
    def check_and_validate_polys(self, polys, tags, img_height, img_width):
        """
        check if the text poly is in the same direction, and also filter some invalid polygons
        """
...
used for generate the score map
    ...
    def generate_quad(self, im_size, polys, tags):
        ...
        geo_map = np.zeros((h, w, 9), dtype=np.float32) # (x1, y1, ..., x4, y4, short_edge_norm)

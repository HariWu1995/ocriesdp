...
class FCEHead(nn.Module):
    ...
    https://arxiv.org/abs/2104.10442 (CVPR2021)
    ...
    def __init__(self, in_channels, fourier_degree=5):
        ...
        self.out_conv_cls = nn.Conv2d(in_channels=self.in_channels, out_channels=self.out_channels_cls,
                                      kernel_size=3, stride=1, padding=1, groups=1,)
        self.out_conv_reg = nn.Conv2d(in_channels=self.in_channels, out_channels=self.out_channels_reg,
                                      kernel_size=3, stride=1, padding=1, groups=1,)
